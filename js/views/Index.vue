<template>
    <div v-if="resourceResponse" class="select-none">
        <heading class="mb-3">{{ resourceResponse.label }}</heading>
        ...
        <card>
            <div class="py-3 flex items-center border-b border-50">
                            ...
                            <div class="p-4">
                                <ul class="list-reset">
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        >
                                            <checkbox :checked="selectAllMatchingChecked" />
                ...
                <div class="flex items-center ml-auto px-3">
                    ...
                    <dropdown class="bg-30 mr-3 px-3 rounded" active-class="" v-if="lenses.length > 0">
...
export default {
    ...
    methods: {
        ...
        async getResources() {
            ...
            const { data } = await axios.get('/nova-api/' + this.resourceName, {
        ...
        getLenses() {
            ...
            axios.get('/nova-api/' + this.resourceName + '/lenses').then(response => {
        ...
        async getAllMatchingResourceCount() {
            const { data: { count } } = await axios.get(
                '/nova-api/' + this.resourceName + '/count',
                {
                    params: this.resourceRequestQueryString,
                }
            )
    ...
    computed: {
        shouldShowResourcePanels() {
            return this.panels.length > 0 && this.resourceName == this.$route.params.resourceName
        },
